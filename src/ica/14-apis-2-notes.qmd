...
```{r httr2_bgg}
req <- request("https://boardgamegeek.com/xmlapi2/search") |>
  req_user_agent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)") |>
  req_url_query(query = "mystery curse", type = "boardgame") |>
